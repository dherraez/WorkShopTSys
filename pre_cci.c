# 1 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c"
...
# 1 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
...
# 2 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
...
# 3 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
...
# 4 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2

# 1 "Booking_Flight.c" 1
Booking_Flight()
{
	...
	if (iCount > 5) {
		lr_end_transaction("WorkShop_BookingFlight_Launch_T01", 0);
		lr_output_message("The count us correct");
	}
	
	else {
		
		lr_end_transaction("WorkShop_BookingFlight_Launch_T01", 1);
	...
	lr_end_transaction("WorkShop_BookingFlight_Login_T02", 2);
...
lr_start_transaction("WorkShop_BookingFlight_ClickFlight_T03");
	...
	lr_end_transaction("WorkShop_BookingFlight_ClickFlight_T03", 2);
	...
	lr_end_transaction("WorkShop_BookingFlight_SelectCity_T04", 2);
	...
	lr_end_transaction("WorkShop_BookingFlight_SelectTime_T05", 2);
	...
	lr_end_transaction("WorkShop_BookingFlight_PaymentDetails_T06", 2);
	...
	lr_end_transaction("WorkShop_BookingFlight_LogOFF_T07", 2);


	return 0;
}
# 5 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
...
# 6 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
...
# 7 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
...
# 8 "c:\\users\\dherraez\\documents\\vugen\\scripts\\workshoptsys\\\\combined_WorkShopTSys.c" 2
